// Sourced from Sunmi's official printer service support classes,
// required as a Parcelable type referenced by IWoyouService.aidl
// (commitPrint), even though this app doesn't call that method directly.
