// Sourced from Sunmi's official printer service AIDL for the P/V series
// (woyou.aidlservice.jiuiv5.IWoyouService), which talks to this device's
// built-in thermal printer via the pre-installed "Printer Service" app.
